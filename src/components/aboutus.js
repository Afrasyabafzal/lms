...
const data = [
...

    {
        avatar: AVTR3,
        name: 'Hassan Ahmed',
        review: 'Designer & Front End Developer'
    },
                        ...
                        >
                            {
                                ...
                                {
                                    return(
                                        <SwiperSlide key={index} className="aboutus bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
